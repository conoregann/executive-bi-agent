...
INSERT INTO raw.subscription_month_snapshots (customer_id, subscription_id, month, mrr_eur_cents, subscription_status, cancelled_at) VALUES
  ...
  ('cust_berlin', 'sub_berlin', '2026-08-01', 110000, 'active', NULL), ('cust_london', 'sub_london', '2026-08-01', 50000, 'active', NULL),
  ('cust_nordic', 'sub_nordic', '2026-08-01', 60000, 'active', NULL), ('cust_riviera', 'sub_riviera', '2026-08-01', 30000, 'active', NULL);
